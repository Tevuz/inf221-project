...
initialize =
    ...
    $ addTower (defaultTower { Tower._position = V2 ( 180) (0), _range = 80 })
    $ addEnemy (defaultEnemy { _progress =  0 * (-60) })
    $ addEnemy (defaultEnemy { _progress =  1 * (-60) })
    $ addEnemy (defaultEnemy { _progress =  2 * (-60) })
    $ addEnemy (defaultEnemy { _progress =  3 * (-60) })
    $ addEnemy (defaultEnemy { _progress =  4 * (-60) })
    $ addEnemy (defaultEnemy { _progress =  5 * (-60) })
    $ addEnemy (defaultEnemy { _progress =  6 * (-60) })
    $ addEnemy (defaultEnemy { _progress =  7 * (-60) })
    $ addEnemy (defaultEnemy { _progress =  8 * (-60) })
    $ addEnemy (defaultEnemy { _progress =  9 * (-60) })
    $ addEnemy (defaultEnemy { _progress = 10 * (-60) })
    $ addEnemy (defaultEnemy { _progress = 11 * (-60) })
    $ addEnemy (defaultEnemy { _progress = 12 * (-60) })
    $ addEnemy (defaultEnemy { _progress = 13 * (-60) })
    $ addEnemy (defaultEnemy { _progress = 14 * (-60) })
    $ addEnemy (defaultEnemy { _progress = 15 * (-60) })
      initial
